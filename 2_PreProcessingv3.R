...
##  Description : try to predict good/bad odor. I used this model for the challenge.
##  Current Status : complete
##  Date of 1st Release :29-01-2019
##  History versions : 
##  2_PreProcessingv1 : first RF
##  2_PreProcessingv2 : try the model without the stalk root
##  2_PreProcessingv2 : try to predict good/bad odor instead of class
##
##  Outputs : file= "Data/ModelAurore_corrected.rds"
##
##  Related Scripts : 
##
##  Comment : My logic is that some oders never lead to poisonus mushrooms. It is more 'conservative'
##  Than the actual class. I used it as my new predicor. I have previously changed the content of the 
##  Factor oder in 'e' and 'p' values. 
##_______________________________________________________________________________________________________## 
...
MushData <- read.csv(file="Data/Odor1.csv", sep=";")

MushData <- MushData[,-1]

## (4) remove obvious features :  ------------------------------------------------------

MushData <- select (MushData, -spore.print.color, -veil.type, -stalk.root, -class)
...
saveRDS(RF, file= "Data/ModelAurore_corrected.rds")
